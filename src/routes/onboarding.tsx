    ...
    <div className="container mx-auto max-w-5xl space-y-8 px-4 py-4 sm:px-6 sm:py-6 lg:px-8 lg:py-8 lg:pt-12">
      ...
      <div className="space-y-4">
        <div className="flex flex-row items-center gap-4">
          <span className="rounded-2xl bg-violet-100 p-2 text-violet-700 dark:bg-violet-400/25 dark:text-violet-400">
            <CentralIcon {...centralIconPropsOutlined28} name="IconGraduateCap" className="size-8" />
          </span>
      ...
      <section className="space-y-3">
        <h2 className="font-manrope text-2xl font-bold tracking-tight text-foreground">Core</h2>
        <div className="flex flex-wrap gap-2">
